...
import { ArrowUpRight, Mail, Send, ShieldCheck, Sparkles } from "lucide-react";
...
export default function DashboardPage() {
  return <main className="dashboard-content">
        ...
        <a className="dashboard-note dashboard-link" href="/dashboard/wysylki"><span className="small-icon"><Mail size={19} /></span><div><h3>Wysyłki ofertowe</h3><p>Przygotuj i wyślij wiadomość do potencjalnych odbiorców.</p></div><span className="open-link">Otwórz <Send size={14} /></span></a>
      </main>;
}
